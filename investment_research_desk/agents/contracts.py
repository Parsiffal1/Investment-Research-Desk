...
AGENT_CONTRACTS: dict[str, AgentContract] = {
    ...
    "data_ingestion": AgentContract(
        name="data_ingestion",
        team="data",
        role="Fetch and normalize market, news, sentiment, and fundamental inputs through route_to_vendor.",
        allowed_inputs=["RunRequest", "provider settings", "fixture data"],
        allowed_tools=[
            "route_to_vendor.get_market_data",
            "route_to_vendor.get_news",
            "route_to_vendor.get_sentiment_inputs",
    ...
    "fundamental_macro": AgentContract(
        ...
        allowed_inputs=["source_metadata.fmp_profile", "source_metadata.fmp_quote", "source_metadata.finnhub_quote", "news_events"],
        allowed_tools=["fundamental_metadata_reader", "macro_event_classifier"],
        forbidden_actions=COMMON_FORBIDDEN_ACTIONS,
    ...
    "news_impact": AgentContract(
        ...
        allowed_inputs=["news_events"],
        allowed_tools=["news_event_classifier", "llm_json_refinement"],
        forbidden_actions=COMMON_FORBIDDEN_ACTIONS,
    ...
    "sentiment": AgentContract(
        ...
        allowed_inputs=["sentiment_inputs"],
        allowed_tools=["sentiment_term_scanner"],
        forbidden_actions=COMMON_FORBIDDEN_ACTIONS,
    ...
    "technical": AgentContract(
        ...
        allowed_tools=["RSI", "MACD", "ATR", "Bollinger Bands", "realized volatility", "max drawdown", "support/resistance"],
        forbidden_actions=COMMON_FORBIDDEN_ACTIONS,
